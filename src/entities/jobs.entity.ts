...
export class Jobs extends BaseEntity {
  ...
  @OneToOne(() => ComposeMailJobs, (jobs) => jobs.composeJob)
  composeJob!: ComposeMailJobs
  ...
  @OneToOne(() => ApplicantStatusJobSeekerProfile, (applicantStatus) => applicantStatus.JobId)
  JobId!: ApplicantStatusJobSeekerProfile

  @OneToOne(() => User, user => user.jobs, {
    cascade: true, onDelete: 'CASCADE', createForeignKeyConstraints: false, nullable: true
  })
  @JoinColumn({ name: "user" })
  user!: User

  @OneToOne(() => CommunicationsMaster, (communication) => communication.jobsCommunication)
  communication!: CommunicationsMaster
